...
class Film {
 ...
 const randomFilm = new Film(1, "Random Film", "Bernardo Aguayo", 1900)
 
 randomFilm.addGenre('Action')
 
 console.log(randomFilm.genres)
 
 console.log(randomFilm.getFilmTitle())
